  ...
  systemd = {
    services = {
      zapret = {
        ...
        serviceConfig = {
          Type = "simple";
          ExecStart = "${pkgs.zapret}/bin/nfqws --daemon --pidfile=/run/nfqws.pid --dpi-desync=fake,split2 --dpi-desync-ttl=1 --dpi-desync-fooling=md5sig --wssize 1:6 --dpi-desync-split-pos=1 --qnum=200";
